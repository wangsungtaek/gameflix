...
for (let mainC=0; mainC<200; mainC++){
    document.querySelector('.grid').innerHTML += div01;
}
for (let lastline =0; lastline<10; lastline++){
    document.querySelector('.grid').innerHTML += div02;
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //move the tetromino left, unless is at the edge or there is a blaockage
    function moveLeft(){
        undraw();
    ...
    //move the tetromino right, unless is at the edge or there is a blaockage
    function moveRight(){
        undraw()
    ...
    //show up-next tetrominoin mini-grid display
